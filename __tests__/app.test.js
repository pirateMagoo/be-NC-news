...
describe('GET api', () => {
 ...
 describe('GET /api/articles/:article_id', () => {
     test('GET 200: sends a single article to the client including comment count, when given an appropriate article_id', () => {
         return request(app)
         .get('/api/articles/1')
         .expect(200)
         .then(({body}) => {
...
describe('PATCH /api/articles/:article_id', () => {
    ...
    test('PATCH 200: responds with original unaltered article when inc_votes is missing', () => {
        return request(app)
        .patch('/api/articles/1')
        .send({})
        .expect(200)
